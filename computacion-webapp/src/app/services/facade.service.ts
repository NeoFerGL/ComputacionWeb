...
const session_cookie_name = 'computacion-token'; // Nombre inicio de sesion(token)
const user_email_cookie_name = 'computacion-email'; // Correo con el que iniciamos sesion
const user_id_cookie_name = 'computacion-user_id'; // Quien inicia sesion
const user_complete_name_cookie_name = 'computacion-user_complete_name'; // nombre completo de la persona
const group_name_cookie_name = 'computacion-group_name'; // Rol
const codigo_cookie_name = 'computacion-codigo'; // codigo propio de las cokes
